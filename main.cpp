...
//
//    //cac dieu kien chan
//    if( ( mPosX < 0 ) || ( mPosX + dot_width > SCREEN_WIDTH ) || ((int)r==0 && (int)g==0   ) )
//    {
//        mPosX -= mVelX;
//    }
//    if( ( mPosY < 0 ) || ( mPosY + dot_height > SCREEN_HEIGHT ) || ((int)r==0 && (int)g==0   ) )
//    {
//        mPosY -= mVelY;
//    }
//}
...
//void toa_do_anh()
//{
//RDot={mPosX,mPosY,dot_width,dot_width};
//RMatrix={50,50,matrix_width,matrix_height};
//}
//
